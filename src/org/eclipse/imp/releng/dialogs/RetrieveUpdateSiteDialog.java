...
public class RetrieveUpdateSiteDialog extends Dialog {
    ...
    protected void createButtonsForButtonBar(Composite parent) {
        ...
        proceedButton.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				String projectRef= buildProjectRef(fProvider, fRepoServer, fRepoPath, fProjectName);
				new WorkbenchReleaseTool().retrieveProject(projectRef, providerRef);
			}
    ...
    protected Control createDialogArea(Composite parent) {
        ...
        fProviderCombo.select(1); // start with SVN
        fProvider= "SVN";
        ...
        fProjectNameText.addModifyListener(new ModifyListener() {
			public void modifyText(ModifyEvent e) {
				fProjectName= fProjectNameText.getText();
			}
        });
