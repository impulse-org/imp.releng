...
// Copied from the internal class TextEditChangePreviewViewer in ltk.ui.refactoring
public class ConfirmChangedFileViewer implements IChangePreviewViewer {
	...
	private static class ComparePreviewer extends CompareViewerSwitchingPane {
		...
		public ComparePreviewer(Composite parent) {
			...
			fCompareConfiguration.setRightLabel("Changed source"); 
